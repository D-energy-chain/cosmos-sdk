...
type MsgCreateValidator struct {
	...
	TokenId cosmossdk_io_math.Int `protobuf:"bytes,9,opt,name=token_id,json=tokenId,proto3,customtype=cosmossdk.io/math.Int" json:"token_id"`
	// amount is the amount being self delegated (as a cosmos.Int scalar).
	NftAmount cosmossdk_io_math.Int `protobuf:"bytes,10,opt,name=nft_amount,json=nftAmount,proto3,customtype=cosmossdk.io/math.Int" json:"nft_amount"`
	// min_self_nft_delegation
	MinSelfNftDelegation cosmossdk_io_math.Int `protobuf:"bytes,11,opt,name=min_self_nft_delegation,json=minSelfNftDelegation,proto3,customtype=cosmossdk.io/math.Int" json:"min_self_nft_delegation"`
...
type MsgDelegateResponse struct {
	...
	ActivationEpoch cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=activation_epoch,json=activationEpoch,proto3,customtype=cosmossdk.io/math.Int" json:"activation_epoch"`
}
...
func (m *MsgDelegateResponse) GetQueueEntryId() uint64 {
	if m != nil {
		return m.QueueEntryId
	}
	return 0
}
...
func (m *MsgCancelQueuedDelegation) Reset()         { *m = MsgCancelQueuedDelegation{} }
func (m *MsgCancelQueuedDelegation) String() string { return proto.CompactTextString(m) }
...
func (m *MsgCancelQueuedDelegation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgCancelQueuedDelegation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgCancelQueuedDelegation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgCancelQueuedDelegation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgCancelQueuedDelegation.Merge(m, src)
}
func (m *MsgCancelQueuedDelegation) XXX_Size() int {
	return m.Size()
}
func (m *MsgCancelQueuedDelegation) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgCancelQueuedDelegation.DiscardUnknown(m)
}

var xxx_messageInfo_MsgCancelQueuedDelegation proto.InternalMessageInfo

func (m *MsgCancelQueuedDelegation) GetDelegatorAddress() string {
	if m != nil {
...
func (m *MsgCancelQueuedDelegation) GetQueueEntryId() uint64 {
	if m != nil {
		return m.QueueEntryId
	}
	return 0
...
func (m *MsgCancelQueuedDelegationResponse) Reset()         { *m = MsgCancelQueuedDelegationResponse{} }
func (m *MsgCancelQueuedDelegationResponse) String() string { return proto.CompactTextString(m) }
...
func (m *MsgCancelQueuedDelegationResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgCancelQueuedDelegationResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgCancelQueuedDelegationResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgCancelQueuedDelegationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgCancelQueuedDelegationResponse.Merge(m, src)
}
func (m *MsgCancelQueuedDelegationResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgCancelQueuedDelegationResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgCancelQueuedDelegationResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgCancelQueuedDelegationResponse proto.InternalMessageInfo

func (m *MsgCancelQueuedDelegationResponse) GetQueueEntryId() uint64 {
	if m != nil {
		return m.QueueEntryId
	}
	return 0
...
func (m *MsgCancelQueuedDelegationResponse) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgCancelQueuedDelegation)(nil), "cosmos.staking.v1beta1.MsgCancelQueuedDelegation")
	proto.RegisterType((*MsgCancelQueuedDelegationResponse)(nil), "cosmos.staking.v1beta1.MsgCancelQueuedDelegationResponse")
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
...
func (c *msgClient) CancelQueuedDelegation(ctx context.Context, in *MsgCancelQueuedDelegation, opts ...grpc.CallOption) (*MsgCancelQueuedDelegationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v1beta1.Msg/CancelQueuedDelegation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) CancelQueuedDelegation(ctx context.Context, req *MsgCancelQueuedDelegation) (*MsgCancelQueuedDelegationResponse, error) {
...
func _Msg_CancelQueuedDelegation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v1beta1.Msg/CancelQueuedDelegation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgCreateValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Watts != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.Watts))
		i--
		dAtA[i] = 0x60
	}
	{
		size := m.MinSelfNftDelegation.Size()
		i -= size
		if _, err := m.MinSelfNftDelegation.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	dAtA[i] = 0x5a
	{
		size := m.NftAmount.Size()
		i -= size
		if _, err := m.NftAmount.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *MsgDelegateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	if m.QueueEntryId != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.QueueEntryId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MsgCancelQueuedDelegation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgCancelQueuedDelegation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgCancelQueuedDelegation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgCancelQueuedDelegationResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgCancelQueuedDelegationResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgCancelQueuedDelegationResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgCreateValidator) Size() (n int) {
	...
	l = m.NftAmount.Size()
	n += 1 + l + sovTx(uint64(l))
	l = m.MinSelfNftDelegation.Size()
	n += 1 + l + sovTx(uint64(l))
	if m.Watts != 0 {
		n += 1 + sovTx(uint64(m.Watts))
	}
	l = len(m.Country)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
...
func (m *MsgDelegateResponse) Size() (n int) {
	...
	_ = l
	if m.QueueEntryId != 0 {
		n += 1 + sovTx(uint64(m.QueueEntryId))
	}
...
func (m *MsgCancelQueuedDelegation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgCancelQueuedDelegationResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgCreateValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NftAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NftAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinSelfNftDelegation", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MinSelfNftDelegation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Watts", wireType)
			}
			m.Watts = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *MsgDelegateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueueEntryId", wireType)
			}
			m.QueueEntryId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QueueEntryId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MsgCancelQueuedDelegation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgCancelQueuedDelegation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgCancelQueuedDelegation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgCancelQueuedDelegationResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgCancelQueuedDelegationResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgCancelQueuedDelegationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
