...
func (m *ValidatorHistoricalRewards) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
type ValidatorHistoricalNFTRewards struct {
	...
	NftCumulativeRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=nft_cumulative_reward_ratio,json=nftCumulativeRewardRatio,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"nft_cumulative_reward_ratio"`
	ReferenceCount           uint32                                      `protobuf:"varint,2,opt,name=reference_count,json=referenceCount,proto3" json:"reference_count,omitempty"`
	// height is the block height when this historical reward period was created
	Height uint64 `protobuf:"varint,3,opt,name=height,proto3" json:"height,omitempty"`
}

func (m *ValidatorHistoricalNFTRewards) Reset()         { *m = ValidatorHistoricalNFTRewards{} }
func (m *ValidatorHistoricalNFTRewards) String() string { return proto.CompactTextString(m) }
...
func (m *ValidatorHistoricalNFTRewards) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorHistoricalNFTRewards) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorHistoricalNFTRewards.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidatorHistoricalNFTRewards) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorHistoricalNFTRewards.Merge(m, src)
}
func (m *ValidatorHistoricalNFTRewards) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorHistoricalNFTRewards) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorHistoricalNFTRewards.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorHistoricalNFTRewards proto.InternalMessageInfo

func (m *ValidatorHistoricalNFTRewards) GetNftCumulativeRewardRatio() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
...
func (m *ValidatorHistoricalNFTRewards) GetReferenceCount() uint32 {
	if m != nil {
		return m.ReferenceCount
	}
	return 0
...
func (m *ValidatorHistoricalNFTRewards) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *DelegatorStartingInfo) GetNftHeight() uint64 {
	if m != nil {
		return m.NftHeight
	}
	return 0
...
type NFTDelegatorStartingInfo struct {
	PreviousPeriod uint64 `protobuf:"varint,1,opt,name=previous_period,json=previousPeriod,proto3" json:"previous_period,omitempty"`
	// nft_stake tracks the amount of NFT delegation stake for this delegator
	NftStake cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=nft_stake,json=nftStake,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"nft_stake"`
	// height is the block height when the first NFT delegation was created for this delegator and validator
	Height uint64 `protobuf:"varint,3,opt,name=height,proto3" json:"creation_height"`
}

func (m *NFTDelegatorStartingInfo) Reset()         { *m = NFTDelegatorStartingInfo{} }
func (m *NFTDelegatorStartingInfo) String() string { return proto.CompactTextString(m) }
...
func (m *NFTDelegatorStartingInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NFTDelegatorStartingInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NFTDelegatorStartingInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NFTDelegatorStartingInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NFTDelegatorStartingInfo.Merge(m, src)
}
func (m *NFTDelegatorStartingInfo) XXX_Size() int {
	return m.Size()
}
func (m *NFTDelegatorStartingInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_NFTDelegatorStartingInfo.DiscardUnknown(m)
}

var xxx_messageInfo_NFTDelegatorStartingInfo proto.InternalMessageInfo

func (m *NFTDelegatorStartingInfo) GetPreviousPeriod() uint64 {
	if m != nil {
		return m.PreviousPeriod
	}
	return 0
...
func (m *NFTDelegatorStartingInfo) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (*CommunityPoolSpendProposalWithDeposit) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*ValidatorHistoricalNFTRewards)(nil), "cosmos.distribution.v1beta1.ValidatorHistoricalNFTRewards")
	...
	proto.RegisterType((*NFTDelegatorStartingInfo)(nil), "cosmos.distribution.v1beta1.NFTDelegatorStartingInfo")
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *ValidatorHistoricalNFTRewards) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ValidatorHistoricalNFTRewards)
	if !ok {
		that2, ok := that.(ValidatorHistoricalNFTRewards)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DelegatorStartingInfo) Equal(that interface{}) bool {
	...
	if this.NftHeight != that1.NftHeight {
		return false
	}
	return true
}
func (this *NFTDelegatorStartingInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*NFTDelegatorStartingInfo)
	if !ok {
		that2, ok := that.(NFTDelegatorStartingInfo)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ValidatorHistoricalNFTRewards) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidatorHistoricalNFTRewards) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorHistoricalNFTRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DelegatorStartingInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.NftHeight != 0 {
		i = encodeVarintDistribution(dAtA, i, uint64(m.NftHeight))
		i--
		dAtA[i] = 0x28
	}
	{
...
func (m *NFTDelegatorStartingInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NFTDelegatorStartingInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NFTDelegatorStartingInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidatorHistoricalNFTRewards) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DelegatorStartingInfo) Size() (n int) {
	...
	n += 1 + l + sovDistribution(uint64(l))
	if m.NftHeight != 0 {
		n += 1 + sovDistribution(uint64(m.NftHeight))
	}
	return n
}

func (m *NFTDelegatorStartingInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ValidatorHistoricalNFTRewards) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorHistoricalNFTRewards: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorHistoricalNFTRewards: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DelegatorStartingInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NftHeight", wireType)
			}
			m.NftHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NftHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NFTDelegatorStartingInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NFTDelegatorStartingInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NFTDelegatorStartingInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
