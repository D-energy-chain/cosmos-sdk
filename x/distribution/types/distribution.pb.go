...
type Params struct {
	...
	// Default: 75% (0.75) of staking rewards, which equals 60% of total newly minted coins
	...
	// This is a percentage of the staking rewards (after community tax is deducted).
	// Default: 25% (0.25) of staking rewards, which equals 20% of total newly minted coins
