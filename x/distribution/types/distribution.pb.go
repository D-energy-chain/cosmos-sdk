...
type Params struct {
	...
	// separate_pool_ratio defines the fraction of total rewards allocated to a separate pool.
	// Default: 5% (0.05) of total newly minted coins
	SeparatePoolRatio cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=separate_pool_ratio,json=separatePoolRatio,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"separate_pool_ratio"`
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.SeparatePoolRatio.Equal(that1.SeparatePoolRatio) {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.SeparatePoolRatio.Size()
		i -= size
		if _, err := m.SeparatePoolRatio.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeparatePoolRatio", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SeparatePoolRatio.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
